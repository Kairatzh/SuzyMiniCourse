    ...
    if state:
        ...
        if action == "register":
            ...
            try:
                ...
                if course:
                    # Format course (returns list of messages)
        ...
        # No state - treat as course generation or chat
        token = get_token(user_id)
